...
import { useCreateProjectMutation, useCreateTechnologyMutation, useLoadedPhotoProjectMutation, useUpdateProjectStudentMutation, useUpdateTechnologyMutation } from "../services/projectsUser";
...
const CreateProjectForm = ({ onClose, updateProject, setUpdateProject }) => {
  ...
  return (
    <div className="absolute inset-0 top-0 pt-60 z-50 flex justify-center items-center overflow-scroll h-[100vh]">
